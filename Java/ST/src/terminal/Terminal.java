...
public class Terminal extends javax.swing.JFrame implements Log, Simulator {
    ...
    private void editable_textBoxes(boolean editable) {
        ...
        jCheckFreeBuffers.setEnabled(editable);
        jTextRcvPackets.setEditable(editable);
    }
    ...
    public void update_Receive_Buffer(int nbuffs) {
    ...
    private void jToggleButtonConnectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonConnectActionPerformed
        if (jToggleButtonConnect.isSelected()) {
            ...
            try {
                ...
                update_Receive_Buffer(net.get_recvbuff());
    ...
    private void jButtonMoreRcvPacketsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonMoreRcvPacketsActionPerformed
        if (net == null)
            return;
        net.add_recvbuff(get_incrbuffers());
